...
function EditMovie(props)
{
    ...
    return(<div>
        ...
        Enter the name of the movie: <input type="text" value={movie.name} onChange={e=> setMovie({...movie, name: e.target.value})}/><br/><br/>
        ...
        Enter the movie image link: <input type="url" value={movie.image} onChange={e=> setMovie({...movie, image: e.target.value})}/><br/><br/>

        Enter the date the movie premiered: <input type="date" value={movie.date} onChange={e=> setMovie({...movie, date: e.target.value})}/><br/><br/>
